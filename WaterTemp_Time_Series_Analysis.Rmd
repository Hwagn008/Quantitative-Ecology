...
This workshop enabled the use of an explanatory series for the improval of models rying to estimate NEE for this ecosystem. Here, NEE (g C m2 day−1), and water temperature maximum, (water.tmax; C) were the variables analyzed, where the best fitting model was created using extreme water temperature. We can see from the model that the 